...
class ConfigFile
{
  ...
  public:
    ...
    AutoVal const& value(std::string const& section, std::string const& entry) const;
    AutoVal const& value(std::string const& section, std::string const& entry, double def);
    AutoVal const& value(std::string const& section, std::string const& entry, bool def);
    AutoVal const& value(std::string const& section, std::string const& entry, int def);
    AutoVal const& value(std::string const& section, std::string const& entry, unsigned int def);
    AutoVal const& value(std::string const& section, std::string const& entry, std::string const& def);
